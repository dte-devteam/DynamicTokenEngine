...
- muxfunction : typedfunction
    - наследует особенности шаблона typedfunction, лишь два важных изменения
		...
		- функция может быть только в скомпилированном виде (возможно будет создано что-то типа function для создания bool и size_t данных, для определения ответа mux)
