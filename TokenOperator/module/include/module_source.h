...
namespace tokenoperator::dte_module {
	struct module_source : dte_token::data::value<std::pair<dte_token::data::smart_pointer<dte_token::object>, bool>> {
		public:
			module_source(std::pair<dte_token::object*, bool> source, module_source_requirement* requirements = nullptr, size_t requirement_num = 0, dte_token::data::scope_path path_to_set = dte_token::data::EMPTY_SCOPE_PATH(0), uint64_t ID = 0);
