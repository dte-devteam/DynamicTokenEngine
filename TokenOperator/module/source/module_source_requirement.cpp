...
module_source_requirement::module_source_requirement(void* target, scope_path source, bool iscritical, uint64_t ID) : value<void*>(ID), source(source), critical(critical) {
	v = target;
}
